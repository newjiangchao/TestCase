...
public class SGDToHKDTest extends AbstractTestNGSpringContextTests {

    @Test(groups = {"smoke", "positive"}, testName = "Determine the amount of SGD exchanged for 100 HKD")
    public void SGDToHKDTestCase1() {
